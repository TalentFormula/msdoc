...
func TestOLE2Reader(t *testing.T) {
    ...
    // Root Entry (Entry 0)
    binary.LittleEndian.PutUint16(strToUtf16("Root Entry")[0], dirSector[0:])
    dirSector[66] = 5                               // Object Type: Root
    binary.LittleEndian.PutInt32(dirSector[76:], 1) // Child ID: 1 (our stream)
    ...
    binary.LittleEndian.PutInt32(dirSector[128+116:], 2)   // Starting Sector: 2
